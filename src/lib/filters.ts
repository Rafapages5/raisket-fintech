...
export const FILTER_DEFINITIONS: Record<FilterType, FilterDefinition> = {
  ...
  'sin-anualidad': {
    ...
    filterFn: (p) => p.meta_data.annuity === 0 || p.badges.includes('Sin Anualidad'),
  ...
  'cashback': {
    ...
    filterFn: (p) => p.meta_data.cashback_rate > 0 || p.benefits.some(b => b.toLowerCase().includes('cashback')),
  ...
  'puntos': {
    ...
    filterFn: (p) => p.meta_data.points_program || p.benefits.some(b => b.toLowerCase().includes('puntos')),
  ...
  'para-estudiantes': {
    ...
    filterFn: (p) => p.badges.includes('Estudiantes') || p.meta_data.min_income === 0,
  ...
  'sin-buro': {
    ...
    filterFn: (p) => p.badges.includes('Sin Buró') || p.meta_data.requires_credit_history === false,
  ...
  'platinum': {
    ...
    filterFn: (p) => p.badges.includes('Platinum') || p.badges.includes('Premium') || p.meta_data.tier === 'premium',
  ...
  'digital': {
    ...
    filterFn: (p) => p.badges.includes('Digital') || p.meta_data.is_digital === true,
  ...
  'sin-aval': {
    ...
    filterFn: (p) => p.meta_data.requires_guarantor === false || p.badges.includes('Sin Aval'),
  ...
  'aprobacion-rapida': {
    ...
    filterFn: (p) => p.badges.includes('Rápido') || p.meta_data.approval_time === 'fast',
  ...
  'tasa-baja': {
    ...
    filterFn: (p) => p.main_rate_numeric !== null && p.main_rate_numeric < 25,
  ...
  'nomina': {
    ...
    filterFn: (p) => p.meta_data.payroll_deduction === true || p.badges.includes('Nómina'),
  ...
  'bajo-riesgo': {
    ...
    filterFn: (p) => p.meta_data.risk_level === 'bajo' || p.badges.includes('Bajo Riesgo'),
  ...
  'alto-rendimiento': {
    ...
    filterFn: (p) => p.main_rate_numeric !== null && p.main_rate_numeric > 10,
  ...
  'desde-100': {
    ...
    filterFn: (p) => p.meta_data.min_investment <= 100,
  ...
  'garantizado': {
    ...
    filterFn: (p) => p.meta_data.guaranteed === true || p.badges.includes('Garantizado'),
  ...
  'sin-comisiones': {
    ...
    filterFn: (p) => p.meta_data.monthly_fee === 0 || p.badges.includes('Sin Comisiones'),
  ...
  'alto-rendimiento-ahorro': {
    ...
    filterFn: (p) => p.main_rate_numeric !== null && p.main_rate_numeric > 5,
  ...
  'retiros-ilimitados': {
    ...
    filterFn: (p) => p.meta_data.free_withdrawals === 'unlimited' || p.benefits.some(b => b.toLowerCase().includes('retiros ilimitados')),
