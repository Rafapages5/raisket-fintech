...
import { Star, Tag, Users, Briefcase, PlusCircle, MinusCircle, Check, ExternalLink, Copy } from 'lucide-react';
...
export default function ProductDetailClient({ product, reviews }: ProductDetailClientProps) {
  ...
  const handleShare = () => {
    ...
    toast({
      ...
      description: "Enlace del producto copiado al portapapeles.",
    });
  };
