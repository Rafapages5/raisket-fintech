...
const reviewSchema = z.object({
  ...
  email: z.string().email({ message: "Por favor ingresa un email válido." }), // Para uso interno, no se muestra
...
export default function ReviewForm({ productId }: ReviewFormProps) {
  ...
  return (
    <Card className="shadow-md">
      <CardHeader>
        <CardTitle className="font-headline text-xl text-primary">Escribir una Reseña</CardTitle>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                     ...
                     <FormDescription className="text-xs">Tu email no será publicado.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
