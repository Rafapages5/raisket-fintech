...
import { Star, Shield, CreditCard, Users, Gift, Award, CheckCircle, Phone, Mail, MapPin, Clock, DollarSign, Percent, Calendar, FileText, Heart, Umbrella, Car, Plane, Smartphone, Headphones, ShoppingCart, Truck } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  const product = {
    ...
    reviewCount: 1340,
    cat: '44.9%',
    creditLimit: 'Hasta $80,000 MXN'
  };

  const financialInfo = {
    interestRate: '44.9% anual',
    cat: '44.9%',
    annualFee: '$0 por 2 años para estudiantes, $400 MXN después',
    creditLimit: 'Hasta $80,000 MXN',
    paymentTerm: '3-18 meses sin intereses'
  };
  ...
  const commissions = [
    { concept: 'Anualidad', amount: '$0 por 2 años estudiantes, $400 MXN después' },
    { concept: 'Comisión por disposición en efectivo', amount: '6% mínimo $25 MXN' },
    { concept: 'Comisión por pago tardío', amount: '$300 MXN' },
    { concept: 'Comisión por exceso de límite', amount: '$300 MXN' },
    { concept: 'Reposición de tarjeta', amount: '$100 MXN' },
    { concept: 'Estado de cuenta digital', amount: 'Gratis' }
  ];

  const insurance = [
    { type: 'Protección de compras en línea', coverage: 'Hasta $10,000 MXN por evento' },
    { type: 'Fraude digital', coverage: '100% de cobertura' },
    { type: 'Seguro para dispositivos móviles', coverage: 'Hasta $8,000 MXN' },
    { type: 'Protección de identidad digital', coverage: 'Monitoreo 24/7' }
  ];
  ...
  const requirements = [
    ...
    'Aplicación desde la app BBVA México'
  ];

  const promotions = [
    { title: 'Bienvenida digital', description: '5,000 puntos BBVA Rewards al activar' },
    { title: 'Streaming sin límites', description: '3x puntos en Netflix, Spotify, Disney+' },
    { title: 'Delivery rewards', description: '2x puntos en Uber Eats, Rappi, DiDi' },
    { title: 'Educación financiera', description: 'Cursos gratuitos y herramientas de ahorro' }
  ];
          ...
          <div className="lg:col-span-2">
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow p-6">
                  <h2 className="text-2xl font-bold text-gray-900 mb-4">Recompensas Digitales</h2>
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center p-4 bg-primary/10 rounded-lg">
                      <Headphones className="h-8 w-8 text-primary mx-auto mb-2" />
                      <h3 className="font-semibold">Streaming</h3>
                      <p className="text-sm text-gray-600">3x puntos</p>
                    </div>
                    <div className="text-center p-4 bg-primary/10 rounded-lg">
                      <Truck className="h-8 w-8 text-primary mx-auto mb-2" />
                      <h3 className="font-semibold">Delivery</h3>
                      <p className="text-sm text-gray-600">2x puntos</p>
                    </div>
                    <div className="text-center p-4 bg-primary/10 rounded-lg">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <p className="text-sm text-gray-600 text-center">
                100% digital • Solo desde la app BBVA México
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-700">Chat en app BBVA</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Clock className="h-5 w-5 text-primary" />
                  <span className="text-gray-700">Soporte digital 24/7</span>
                </div>
              </div>
            </div>

            <div className="bg-primary/10 rounded-lg p-6">
              <h3 className="text-lg font-bold text-primary mb-2">Para Jóvenes</h3>
              <ul className="text-sm text-gray-700 space-y-2">
                <li>• Diseñada para millennials y gen Z</li>
                <li>• Recompensas en tu estilo de vida</li>
                <li>• Control total desde tu móvil</li>
                <li>• Educación financiera gratuita</li>
              </ul>
            </div>
          </div>
        </div>
