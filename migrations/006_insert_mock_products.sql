-- Migration: Insert mock products data into financial_products
-- Description: Inserts sample product data for testing
-- Date: 2025-09-13

-- Insert sample products into financial_products table
